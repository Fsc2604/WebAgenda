<%@ Page Title="" Language="C#" MasterPageFile="~/BackEnd.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="WebAgenda.Usuarios" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>Lista de usuários</h3>
    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1Usuarios" DataKeyNames="email" InsertItemPosition="LastItem" OnSelectedIndexChanged="ListView1_SelectedIndexChanged">
...
<asp:SqlDataSource ID="SqlDataSource1Usuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [usuario] WHERE [email] = @email" 
    ...
    UpdateCommand="UPDATE [usuario] SET [nome] = @nome, [senha] = @senha WHERE [email] = @email" OnInserted="SqlDataSource1Usuarios_Inserted" OnUpdated="SqlDataSource1Usuarios_Updated">
    <DeleteParameters>
